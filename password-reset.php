        ...
        <div class="py-20">
            ...
            <div class="contact-form__two ">
                ...
                <div class="contact-inner">
                    <input name="email" id="email" type="email" placeholder="Confirm email address *">
                </div>
                <div class="contact-inner">
                    <input name="password" id="password" type="password" placeholder="Choose new password *">
                </div>
                <div class="contact-inner">
                ...
                <div class="comment-submit-btn text-left">
                    <button class="ht-btn ht-btn-md" type="button" id="resetBtn">Reset password</button>
...
$(document).ready(function() {
    $('#resetBtn').on("click", function() {
        ...
        $.ajax({
            type: "POST",
            url: "consumer/methods/password-reset.php",
            dataType: 'json',
            data: {
                "email": $("#email").val(),
                "token": $("#token").val(),
