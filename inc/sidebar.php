    ...
    <div class="deznav-scroll">
        ...
        if(isset($_SESSION["user_role"]) && $_SESSION["user_role"] == "admin"){ ?>
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow ai-icon" href="airtime2cash-list.php?page=1" aria-expanded="false" data-toggle="tooltip"
                ...
                <li><a class="has-arrow ai-icon" href="all-transaction-history.php?page=1" aria-expanded="false" data-toggle="tooltip"
