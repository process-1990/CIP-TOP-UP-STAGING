    ...
    if (!isset($_COOKIE["user_role"]) || $_COOKIE["user_role"] != "admin") { ?>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-6 col-xxl-6 col-lg-6">
                    <div class="widget-stat card" style="display: flex; justify-content: center; padding: 15px;">
                        <div class="row">
                            <div class="col-md-2 text-danger  justify-content-center align-content-center" style="display: flex;">
                            ...
                            <div class="col-md-2 justify-content-center align-content-center" style="display: flex;">
                                <button type="button" class="btn btn-rounded btn-secondary text-white p-1" style="font-size: 11px;" onclick="goto('wallet-funding', 'Fund Wallet', 'fund wallet');">Fund Wallet</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4 mt-3" id="shortcut">
                ...
                <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6">
                    <div class="widget-stat card" onclick="goto('buy-data-form', 'Provider MTN', 'MTN')" style="background-color: #face33;">
                        <div class="card-body p-0">
                ...
                <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6">
                    <div class="widget-stat card" onclick="goto('buy-data-form', 'Provider Airtel', 'Airtel');" style="background-color: #e93f33;">
                        <div class="card-body p-0">
                ...
                <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6">
                    <div class="widget-stat card" onclick="goto('cable-form', 'Provider DSTV', 'dstv');" style="background-color: #013e5d;">
                        <div class="card-body p-0">
                        ...
                        <div class="card-body">
                            <ul class="row nav nav-pills mb-4 light">
                                <li class="col-lg-2 col-md-2 col-sm-2 text-center  nav-item">
                                    <a href="#navpills-1" class="nav-link active" data-toggle="tab" aria-expanded="false">Data</a>
                                </li>
                                <li class="col-lg-3 col-md-2 col-sm-2 text-center nav-item">
                                    <a href="#navpills-2" class="nav-link" data-toggle="tab" aria-expanded="false">Airtime</a>
                                </li>
                                <li class="col-lg-2 col-md-2 col-sm-2 text-center nav-item">
                                    <a href="#navpills-3" class="nav-link" data-toggle="tab" aria-expanded="true">TV</a>
                                </li>
                                <li class="col-lg-3 col-md-2 col-sm-2 text-center nav-item">
                                    <a href="#navpills-4" class="nav-link" data-toggle="tab" aria-expanded="true">Electricity</a>
                                </li>
                                <li class="col-lg-2 col-md-2 col-sm-2 text-center nav-item">
                            ...
                            <div class="tab-content">
                                <div id="navpills-1" class="tab-pane active">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6">
                                            <div class="widget-stat card" onclick="goto('buy-data-form', 'Provider 9Mobile', '9mobile')" style="background-color: #e93f33;">
                                                <div class="card-body p-0">
                                                    <img src="public/images/9mobile.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('ntel', 'Provider Ntel', 'Ntel')" style="background-color: #e93f33;">
                                                <div class="card-body p-0">
                                                    <img src="public/images/ntel.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('smile', 'Provider Smile', 'Smile')" style="background-color: #e93f33;">
                                                <div class="card-body p-0">
                                                    <img src="public/images/smile.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="navpills-2" class="tab-pane">
                                    <div class="row">
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('buy-airtime-form', 'Provider MTN', 'MTN')" style="background-color: #face33;">
                                                <div class="card-body p-0">
                                                    <img src="public/images/mtn.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('buy-airtime-form', 'Provider Glo', 'Glo')">
                                                <div class="card-body p-0">
                                                    <img src="public/images/glo.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('buy-airtime-form', 'Provider Airtel', 'Airtel')" style="background-color: #e93f33;">
                                                <div class="card-body p-0">
                                                    <img src="public/images/airtel.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                ...
                                <div id="navpills-3" class="tab-pane">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6">
                                            <div class="widget-stat card" onclick="goto('cable-form', 'Provider Startimes', 'startimes');">
                                                <div class="card-body p-0">
                                                    <img src="public/images/startimes.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="navpills-4" class="tab-pane">
                                    <div class="row">
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('power-form', 'Provider EKEDC', 'EKEDC');">
                                                <div class="card-body p-0">
                                                    <img src="public/images/eko.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('power-form', 'Provider IKEDC', 'IKEDC');">
                                                <div class="card-body p-0">
                                                    <img src="public/images/ikeja.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('power-form', 'Provider AEDC', 'AEDC');">
                                                <div class="card-body p-0">
                                                    <img src="public/images/aedc.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('power-form', 'Provider KEDCO', 'KEDCO');">
                                                <div class="card-body p-0">
                                                    <img src="public/images/kano.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('power-form', 'Provider KAEDC', 'KAEDC');">
                                                <div class="card-body p-0">
                                                    <img src="public/images/kaduna.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('power-form', 'Provider PHEDC', 'PHEDC');">
                                                <div class="card-body p-0">
                                                    <img src="public/images/phed.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('power-form', 'Provider JEDC', 'JEDC');">
                                                <div class="card-body p-0">
                                                    <img src="public/images/jos.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card" onclick="goto('power-form', 'Provider IBEDC', 'IBEDC');">
                                                <div class="card-body p-0">
                                                    <img src="public/images/ibadan.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                        <!-- <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                ...
                                <div id="navpills-5" class="tab-pane">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6  mb-2">
                                            <div class="widget-stat card">
                                                <div class="card-body p-0">
                                                    <img src="public/images/giftcard.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-xxl-2 col-lg-2 col-sm-6 mb-2">
                                            <div class="widget-stat card">
                                                <div class="card-body p-0">
                                                    <img src="public/images/referrer.png" width="100%" height="100%" class="custom-img" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <form id="buy-data-form" class="row mt-3">
                <div class="col-xl-6 col-xxl-6 offset-3">
                    <div class="card" style="background-color: #40189D">
                                ...
                                <div class="col-lg-12 mt-2">
                                    ...
                                    <div class="row form-group mb-0">
                                        ...
                                        <div class="col-lg-8 form-group form-inline">
                                            <label class="radio-inline mr-2 text-white" style="font-size: 13px;"><input type="radio" name="payOption" id="payOption" value="main" class="mr-1" checked style="height:15px; width:15px; vertical-align: middle;"> Main
                                                Account</label>
                                            <label class="radio-inline mr-1 text-white" style="font-size: 13px;"><input type="radio" name="payOption" id="payOption" value="bonus" class="mr-1" style="height:15px; width:15px; vertical-align: middle;"> Bonus
                                                Account</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <button type="submit" class="card-footer text-center text-white bg-warning" style="cursor: pointer;" id="buyDataBtn">
                            Buy
                        </button>
                    </div>
                </div>
                    ...
                    <div class="card" style="background-color: #40189D">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-2">
                                    <div class="form-group">
                                        <input class="form-control" name="airtime_phone_number" id="airtime_phone_number" type="text" placeholder="Mobile number *">
                                        <input type="hidden" class="form-control" name="identifier" id="identifier" type="text">
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-2" id="amount-lyt">
                                    <div class="form-group">
                                        <input class="form-control" name="amount" id="amount" type="text" placeholder="Amount *">
                                    </div>
                                </div>
                                <div class="col-lg-12 mt-2">
                                    <input class="form-control" name="carrier" id="carrier" type="hidden">
                        ...
                        <button class="card-footer text-center text-white bg-warning" style="cursor: pointer;" id="buyAirtimeBtn">
                            Buy
                        </button>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-1">
                                        <input class="form-control card-checker" name="smartCardNo" id="smartCardNo" type="text" placeholder="SmartCard Number" style="display: none;">
                                        <input class="form-control card-checker" name="iucnumber" id="iucnumber" type="text" placeholder="IUC Number" style="display: none;">
                                        <input class="form-control card-checker" name="st-number" id="st-number" type="text" placeholder="Startimes Number" onkeydown="confirmST()" onkeyup="confirmST();" style="display: none;">
                                    </div>
                                    <div class="bootstrap-badge mb-2">
                                        <a href="javascript:void()" class="badge badge-rounded badge-outline-light text-white" id="cable-checker"></a>
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <div class="bootstrap-badge mb-2">
                                            <a href="javascript:void()" class="badge badge-rounded badge-outline-light text-white" id="cable-current"></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 mb-2">
                                    <div class="form-group">
                                        <select class="form-control" id="gotv-plan" name="gotv-plan" onchange="setGotvPrice();" style="display: none">
                                            <option value="">Select plan</option>
                                        </select>
                                        <input type="hidden" name="gotv-plan-code" id="gotv-plan-code" style="display: none;" />
                                        <select class="form-control" id="dstv-plan" name="dstv-plan" onchange="setDstvPrice();" style="display: none">
                                            <option value="">Select plan</option>
                                        </select>
                                        <input type="hidden" name="dstv-plan-code" id="dstv-plan-code" />
                                        <select class="form-control" id="st-plan" name="st-plan" onchange="setSTPrice();" style="display: none">
                                            <option value="">Select plan</option>
                                        </select>
                                ...
                                <div class="col-lg-12 mt-2">
                                    <div class="row form-group mb-0">
                                        ...
                                        <div class="col-lg-8 form-group form-inline">
                                            <label class="radio-inline mr-2 text-white" style="font-size: 13px;"><input type="radio" name="cableOption" id="cableOption" value="main" class="mr-1" checked style="height:15px; width:15px; vertical-align: middle;"> Main
                                                Account</label>
                                            <label class="radio-inline mr-1 text-white" style="font-size: 13px;"><input type="radio" name="cableOption" id="cableOption" value="bonus" class="mr-1" style="height:15px; width:15px; vertical-align: middle;">
                                                Bonus Account</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 mb-2">
                                    <div class="form-group">
                                        <input class="form-control" name="cable-amount" id="cable-amount" type="text" placeholder="Amount *" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer text-center text-white bg-warning" style="cursor: pointer;" id="payCableBtn" onclick="purchaseCable(this.id);">
                            Pay
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card" style="background-color: #40189D">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-1">
                                        <input class="form-control" name="distribution-company" id="distribution-company" type="hidden" placeholder="Distribution Company">
                                        <input class="form-control" name="meterNo" id="meterNo" type="text" placeholder="Meter Number" onkeydown="confirmMeter()" onkeyup="confirmMeter();">
                                    </div>
                                    <div class="bootstrap-badge mb-2">
                                        <a href="javascript:void()" class="badge badge-rounded badge-outline-light text-white" id="meter-checker"></a>
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-2">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12 mt-2">
                                    <div class="row form-group mb-0">
                                        ...
                                        <div class="col-lg-8 form-group form-inline">
                                            <label class="radio-inline mr-2 text-white" style="font-size: 13px;"><input type="radio" name="powerOption" id="powerOption" value="main" class="mr-1" checked style="height:15px; width:15px; vertical-align: middle;"> Main
                                                Account</label>
                                            <label class="radio-inline mr-1 text-white" style="font-size: 13px;"><input type="radio" name="powerOption" id="powerOption" value="bonus" class="mr-1" style="height:15px; width:15px; vertical-align: middle;">
                                                Bonus Account</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-2">
                                    <div class="form-group">
                                        <input class="form-control" name="power-buy-amount" id="power-buy-amount" type="number" placeholder="Amount *" onkeyup="powerPurchaseCalculator(this.id);">
                                ...
                                <div class="col-lg-12 mb-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="power-amount" id="power-amount" type="number" placeholder="Total amount" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer text-center text-white bg-warning" style="cursor: pointer;" id="payPowerBtn" onclick="purchasePower(this.id);">
                            Pay
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-5 col-xxl-6 offset-1">
                    <div class="card" style="background-color: #40189D">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12 text-center justify-content-center align-content-middle pb-3">
                                    <span><img src="public/images/airtimetocash.png" width="120px" height="auto" class="custom-img" /></span>
                                    <h5 class="text-white mt-3">Please provide details:</h5>
                                </div>
                                <div class="col-lg-6 mb-1">
                                    <div class="form-group">
                                        <label class="text-white">Sender's phone number:</label>
                                        <input class="form-control" name="atc-phonenumber" id="atc-phonenumber" type="text" placeholder="E.G 08012345678">
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-1">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6 mb-1">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="atc-amount" id="atc-amount" type="text" placeholder="Input amount *" onkeydown="calculateReturn()" onkeyup="calculateReturn()">
                                    </div>
                                </div>
                                <div class="col-lg-6 mb-1">
                                    <div class="form-group">
                                        <label class="text-white">Rate (in %)</label>
                                        <input class="form-control" name="atc-amount" id="atc-amount" type="text" value="20" disabled>
                                    </div>
                                </div>
                        ...
                        <div class="card-footer text-center text-white bg-warning" style="cursor: pointer;" id="airtimeToCashBtn">
                            Continue
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-xxl-6 offset-3">
                    <div class="card" style="background-color: #40189D">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12 text-center justify-content-center align-content-middle pb-3">
                                    <span><img src="public/images/transferCip.png" width="120px" height="auto" class="custom-img" /></span>
                                    <h5 class="text-white mt-3">Please provide details:</h5>
                                </div>
                                <div class="col-lg-12 mb-2">
                                    <div class="form-group">
                                        <input class="form-control" name="wtw-email" id="wtw-email" type="text" placeholder="Recipient email *">
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-2">
                                    <div class="form-group">
                                        <input class="form-control" name="wtw-amount" id="wtw-amount" type="text" placeholder="Amount to transfer? *">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer text-center text-white bg-warning" style="cursor: pointer;" id="wtwBtn" onclick="waletToWallet(this.id);">
                            Transfer
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-xxl-6 offset-3">
                    <div class="card" style="background-color: #40189D">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12 text-center justify-content-center align-content-middle pb-3">
                                    <span><img src="public/images/referrer.png" width="120px" height="auto" class="custom-img" /></span>
                                    <h5 class="text-white mt-3">Please provide details:</h5>
                                </div>
                                <div class="col-lg-12 mb-2">
                                    <div class="form-group">
                                        <input class="form-control" name="wf-amount" id="wf-amount" type="text" placeholder="Amount to fund? *">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mt-2">
                                <div class="row form-group mb-0">
                                    ...
                                    <div class="col-lg-8 form-group form-inline">
                                        <label class="radio-inline mr-2 text-white" style="font-size: 13px;"><input type="radio" name="fundingOption" id="fundingOption" value="paystack" class="mr-1" checked style="height:15px; width:15px; vertical-align: middle;"> Paystack</label>
                                        <label class="radio-inline mr-1 text-white" style="font-size: 13px;"><input type="radio" name="fundingOption" id="fundingOption" value="monnify" class="mr-1" style="height:15px; width:15px; vertical-align: middle;">
                                            Monnify</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer text-center text-white bg-warning" style="cursor: pointer;" id="fwBtn" onclick="fundWallet(this.id);">
                            Fund
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="font-size: 13px;">
                                                    <?php $dat = explode("T", $users['created_at']);
                                                    echo $dat[0]; ?></td>
                                                <td style="font-size: 13px;">
                                                    <?php $dat = explode("T", $users['updated_at']);
                                                    echo $dat[0]; ?></td>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="font-size: 13px;">
                                                    <?php $dat = explode("T", $trans->created_at);
                                                    echo $dat[0]; ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
